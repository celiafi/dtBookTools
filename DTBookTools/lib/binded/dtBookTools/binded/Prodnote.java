 ...
 *       &lt;group ref="{http://www.daisy.org/z3986/2005/dtbook/}flow" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;attGroup ref="{http://www.daisy.org/z3986/2005/dtbook/}attlist.prodnote"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Prodnote {
    ...
    @XmlAttribute
    @XmlIDREF
    protected java.util.List<Object> imgref;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the imgref property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getImgref().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public java.util.List<Object> getImgref() {
        if (imgref == null) {
            imgref = new ArrayList<Object>();
        }
        return this.imgref;
    }
